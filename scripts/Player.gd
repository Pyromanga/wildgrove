...
# Wir laden Basis-Werte jetzt direkt aus dem Kernel.data Service
	...
	add_to_group("player")
    	_build_player_nodes()
            ...
            func _physics_process(delta: float) -> void:
            	# 1. Status-Check: Zugriff via Kernel.states
                            		...
                            		velocity.z = 0
                                    		move_and_slide()
                                            		return
                                                    	...
                                                    	# 2. Input holen: Wir greifen direkt auf die Kernel-Instanz zu
                                                                                                                                                                                                                                                                                                                                                                        	...
                                                                                                                                                                                                                                                                                                                                                                        	_spring_arm.add_excluded_object(get_rid()) 
                                                                                                                                                                                                                                                                                                                                                                            	add_child(_spring_arm)
                                                                                                                                                                                                                                                                                                                                                                                	...
                                                                                                                                                                                                                                                                                                                                                                                	var cam := Camera3D.new()
                                                                                                                                                                                                                                                                                                                                                                                    	cam.current = true
                                                                                                                                                                                                                                                                                                                                                                                        	_spring_arm.add_child(cam)extends